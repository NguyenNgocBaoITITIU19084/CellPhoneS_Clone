  ...
  return (
    <>
      <ProductCardsContainer>
            <ProductCardsWrapper>
              <Card sx={{ maxWidth: 225, maxHeight: '465px', padding: '8px 4px', position: 'relative'}}>
                ...
                <CardMedia
                  sx={{ height: {xs: '120px'}, width: {xs: '120px'}, objectFit: 'contain', margin: {xs: '0 auto'} }}
                ...
                <CardContent sx={{ padding: '5px'}}>
                  <Typography gutterBottom variant='span' fontWeight='bold' sx={{ fontSize: '0.875rem' }}>
                    Iphone Air 256GB | Chính Hãng
                  </Typography>
                  <ProductDetailContainer>
                    <ProductStatus variant='span' sx={{ fontSize: '0.875rem' }}>Hàng mới về</ProductStatus>
                    <PriceContainer >
                      <Typography fontWeight='bold' color='primary.main' sx={{ fontSize: '0.875rem'}}>31.990.000đ</Typography>
                      <Typography fontSize='small' sx={{ textDecorationLine: 'line-through' }}>31.990.000đ</Typography>
                    </PriceContainer>
                    <SmemberDiscount sx={{ fontSize: '0.7rem'}}>Smember giảm đến 320.000đ</SmemberDiscount>
                    <Typography variant='span' component='div' sx={{ backgroundColor: 'rgb(242,242,243)', padding: '4px', fontSize: '0.7rem'}}>
                ...
                <CardActions sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: 0}}>
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: '0.2rem' }}>
                    <StarIcon sx={{ color: 'primary.main', fontSize: '0.875rem' }}/>
                    <Typography fontWeight='bold' color='primary.main'>5</Typography>
                  </Box>
                  <Button  sx={{display: {xs: 'none'}}} size='small' startIcon={<FavoriteBorderIcon/>}>Yêu Thích</Button>
                  <FavoriteBorderIcon sx={{ display: {xs: 'block'}, fontSize: '1rem'}}/>
                </CardActions>
              </Card>
            </ProductCardsWrapper>
          </ProductCardsContainer>
